...
- 2026-09-06 (from 038 review, low): meter captions split into a muted name and an ink value (weight
  500) as the Swiss mock does; today the whole caption is muted. Needs a span in `Meters`.
- 2026-09-06 (from 038 review, low): the paused-invite composer hint ("Send will work again the moment
  your host resumes your invite.") is prose set in mono via `.hint`; give the keyboard legend its own
  mono class and let prose hints use Archivo.
