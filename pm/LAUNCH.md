...
|---|---|---|---|
| F1 | **Name** | Invite prefix, binary name, web title, social post all carry it; renaming after launch breaks copied invites | **DECIDED 2026-09-05: Infercat** (`infercat`, prefix `ic1`). Founder's ruling after three PM rounds and a knockout on the founder's own three (docs/NAME.md). Rename executed as ticket 037. Accepted costs, recorded: Inferact near-homograph; infercat.com parked at $9,800 (do not buy now); "infer" reads engine at first glance (tagline carries the offer); "-cat" reads tailcat lineage (README disclaims affiliation). |
