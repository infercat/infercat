...
|---|---|---|---|
| F1 | **Name** | Invite prefix, binary name, web title, social post all carry it; renaming after launch breaks copied invites | **DECIDED 2026-09-05: Infercat** (`infercat`, prefix `ic1`). Founder's ruling after three PM rounds and a knockout on the founder's own three (docs/NAME.md). Rename LANDED 2026-09-06 as ticket 037 (main `0b2173f`; 103 files; every gate green; GitHub repo renamed to `2185Lab/infercat`, old path redirects; the demo host runs the Infercat build with an `ic1` invite). Accepted costs, recorded: Inferact near-homograph; infercat.com parked at $9,800 (do not buy now); "infer" reads engine at first glance (tagline carries the offer); "-cat" reads tailcat lineage (README disclaims affiliation). |
...
| F8 | **Brand look** | The web app, cards, icons and README carry the look; changing it after launch is a second first impression | Founder brief 2026-09-06: not the beige/orange/cream chat-app look; something differentiated. Contest done 2026-09-06: six directions on one page, https://claude.ai/code/artifact/11ec5b1c-2b39-4401-9d67-47954f1585a7 (files in the job tmp `design/`). PM ranking: 1 Riso Zine (two spot inks, tipped-ear colony cat), 2 Swiss ink, 3 Cat-eye, 4 Nocturne, 5 BBS, 6 Tuxedo. **DECIDED 2026-09-06: Swiss ink** (founder), with the mascot revised to be cuter and not ghostly (the slit eyes read as a ghost). Implementation: ticket 038 **LANDED 2026-09-06** (tokens both schemes, Archivo + Plex Mono self-hosted with OFL notices, zero radius, ink rules, cobalt actions, cards, README header; three verifier lenses, one fix round, PM landing fixes); the demo host runs it; mark revision: contest of 8 marks in the Swiss idiom for the founder's pick, then a one-file swap. Domain facts 2026-09-06: infercat.com registered 2025-09-11 by a speculator, listed for sale (~$9,800), **expires 2026-09-11** (renewal grace follows; a drop would be ~Oct–Nov); .dev/.app/.ai unregistered. |
