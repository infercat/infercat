...
| F8 | **Brand look** | The web app, cards, icons and README carry the look; changing it after launch is a second first impression | Founder brief 2026-09-06: not the beige/orange/cream chat-app look; something differentiated. Contest running: six independent directions (Nocturne, BBS, Swiss ink, Tuxedo, Cat-eye, Wildcard), each a full mockup of the real surfaces in both schemes, presented on one comparison page; founder picks; then one ticket implements the tokens, mark and cards on top of 037. |
