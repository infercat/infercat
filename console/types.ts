...
export interface Settings { writes_supported?:boolean; default_web_url?:string; configured_console?:string; console_address?:string; running_slots?:number; saved_at?:Record<string,string>; remote?:{warning_file?:string;enabled:boolean;since?:string;in_use:boolean}; name: string; web_url: string; configured_web_url: string; slots: number; log_requests: boolean; log_requests_remembered: boolean; log_prompts: boolean; upstream: string; derpmap_url: string; region: string; data_dir: string }
