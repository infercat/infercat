...
def ear(base_out, tip, base_in, rt=1.1):
...
def ears_soft(cx, y_out, y_tip, x_out, x_tip, x_in, y_in):
    L=ear((x_out,y_out),(x_tip,y_tip),(x_in,y_in)); R=ear((2*cx-x_out,y_out),(2*cx-x_tip,y_tip),(2*cx-x_in,y_in)); return [L,R]
V={}
...
V['face-sharp']=svg(head+eyes(16,17.6,4.7,3.6), [poly([(6.0,11.0),(5.2,3.2),(12.4,7.4)]), poly([(26.0,11.0),(26.8,3.2),(19.6,7.4)])])
